...
describe('Services: WeightService', () => {
    ...
    incorrectWeightArr.push(incorrectWeight)
    ...
    //
    //             try {
    //                 return await weightService.add(incorrectWeight)
    //             } catch (err) {
    ...
    //         it('should throw a ValidationException', async () => {
    //             incorrectWeight = new WeightMock()
    //             incorrectWeight.child_id = '5a62be07de34500146d9c5442'           // Make child_id invalid
    //             sinon
    //                 .mock(modelFake)
    //                 .expects('create')
    //                 .withArgs(incorrectWeight)
    ...
    //         it('should throw a ValidationException', async () => {
    //             incorrectWeight.child_id = '5a62be07de34500146d9c544'           // Make child_id valid
    //             incorrectWeight.type = 'invalidType'
    //             sinon
    //                 .mock(modelFake)
    //                 .expects('create')
    //                 .withArgs(incorrectWeight)
    ...
    //                 .resolves(true)
    //
    //             weightRepo.disassociateBodyFat(weight.id)   // Disassociate Weight from Weight object
    //                 .then(result => {
    ...
    //         it('should throw a ValidationException', () => {
    //             connectionRabbitmqPub.isConnected = true
    //             incorrectWeightFat.child_id = '5a62be07de34500146d9c5442'     // Make child_id invalid
    //             sinon
    //                 .mock(modelFake)
    //                 .expects('findOneAndDelete')
    //                 .withArgs({ child_id: incorrectWeightFat.child_id, _id: incorrectWeightFat.id, type: incorrectWeightFat.type })
    //                 .chain('exec')
    //                 .rejects({ message: Strings.CHILD.PARAM_ID_NOT_VALID_FORMAT,
    //                     description: Strings.ERROR_MESSAGE.UUID_NOT_VALID_FORMAT_DESC })
    //
    //             return weightService.removeByChild(incorrectWeightFat.id!, incorrectWeightFat.child_id)
    //                 .catch (err => {
    //                     assert.propertyVal(err, 'message', Strings.CHILD.PARAM_ID_NOT_VALID_FORMAT)
    //                     assert.propertyVal(err, 'description', Strings.ERROR_MESSAGE.UUID_NOT_VALID_FORMAT_DESC)
    //                 })
    ...
    //         it('should throw a ValidationException', () => {
    //             incorrectWeightFat = new WeightMock()
    //             incorrectWeightFat.id = '5a62be07de34500146d9c5442'       // Make weight id invalid
    //             sinon
    //                 .mock(modelFake)
    //                 .expects('deleteOne')
    //                 .withArgs({ child_id: incorrectWeightFat.child_id, _id: incorrectWeightFat.id, type: incorrectWeightFat.type })
