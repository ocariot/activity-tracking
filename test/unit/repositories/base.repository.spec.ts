            ...
            it('should return a sleep object.', () => {
                ...
                return repo.create(defaultSleep)
                    .then(sleep => {
                        ...
                        assert.propertyVal(sleep, 'start_time', defaultSleep.start_time!.toISOString().substr(0, 19))
                        assert.propertyVal(sleep, 'end_time', defaultSleep.end_time!.toISOString().substr(0, 19))
        ...
        it('should return a list of sleep activities', () => {
            ...
            return repo.find(queryMock)
                .then((sleepArr: Array<Sleep>) => {
                    ...
                    assert.propertyVal(sleepArr[0], 'start_time', defaultSleep.start_time!.toISOString().substr(0, 19))
                    assert.propertyVal(sleepArr[0], 'end_time', defaultSleep.end_time!.toISOString().substr(0, 19))
